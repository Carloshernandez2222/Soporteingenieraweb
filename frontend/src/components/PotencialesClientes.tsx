const ICONS = [
  ...
  },
  {
    label: "Logo",
    svg: (
      <span className="text-xs font-bold text-gray-850">LOGO IPSUM</span>
    ),
  },
  {
    label: "Proceso",
    ...
    <section className="py-16 md:py-24 bg-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
          Pensado para operaciones como:
        </p>
        <div className="mt-12 flex flex-wrap justify-center gap-8 md:gap-12">
          {ICONS.map(({ label, svg }) => (
            <div
              key={label}
              className="flex flex-col items-center gap-2 text-gray-850"
              aria-hidden
            >
              <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-white border border-gray-200 shadow-sm text-gray-700">
                {svg}
              </div>
            </div>
          ))}
