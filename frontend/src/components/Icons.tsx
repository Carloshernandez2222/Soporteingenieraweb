/** Iconos SVG discretos, estilo línea (soporte / enterprise). */

type IconProps = { className?: string; size?: number };

export function IconTicket({ className, size = 20 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconHealth({ className, size = 20 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
