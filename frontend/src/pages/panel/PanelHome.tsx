...
const allCards: Card[] = [
  ...
  },
  {
    ...
    apiLine: "GET /casos/sqlite/por-solicitante",
  ...
  },
  {
    ...
    apiLine: "POST /casos/integracion",
    icon: <IconClipboard size={22} />,
    roles: ["soporte"],
  },
  {
    ...
    apiLine: "GET /casos/metricas-jerarquicas",
    icon: <IconClipboard size={22} />,
    roles: ["soporte"],
  },
  {
